...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='adobo-grid']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"AdoboGrid","hydrated",[["adobo-grid","adobo-grid",1,[["first",1,0,1,2],["last",1,0,1,2],["middle",1,0,1,2]],1]]);